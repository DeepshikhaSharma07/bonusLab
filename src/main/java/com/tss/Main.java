...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String promptAnswer = scanner.nextLine().toLowerCase();
        ...
        if (promptAnswer.equals("y") || promptAnswer.equals("yes")) {
            ...
            String favPetName = scanner.next().toLowerCase();
...
//                System.out.println(qbNumber + " is a fitting number for the QB!");
                ...
                int qbNumber = 0;
                System.out.println("That's ok if you don't have the quaterback number.");
            }
